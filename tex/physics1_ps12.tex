...
Due Tuesday 2025 November 25 by 23:59 NYC time on Brightspace.
Be sure to give credit to all your sources, as per all policies.

\paragraph{\problemname~\theproblem:}\refstepcounter{problem}%
HOGG MAKE THIS PROBLEM JUST ABOUT MASHED POTATOES
...
\paragraph{\problemname~\theproblem:}\refstepcounter{problem}%
Things in low-Earth orbit, like the Hubble Space Telescope, are subject
to a tiny bit of residual air drag, because the atmosphere has a trace component
that extends up to very altitude.

\textsl{(a)}
Consider a satellite orbiting the Earth on a circular orbit at $400\,\km$ altitude,
what is the semi-major axis $a$ of the orbit and its speed $v$ relative to the Earth, in SI units?
If the satellite has a surface area of about $A=5\,\m^2$, and a mass of about
$m=10^4\,\kg$ (these are about right for Hubble) what (naively and approximately) is the drag
force on the satellite in SI units? You will have to look up the density $\rho$ of the residual atmosphere at this altitude.

\textsl{(b)}
If you think of this drag force as providing a \emph{torque} on the orbit, what
is that torque? Does it increase or decrease the angular momentum of the orbit?
What happens (in this case) to the orbital radius $a$ with time? Quantitatively
compute $\dd a/\dd t$ in this case. You might have to use chain rule, and remember
that $\tau = \dd L/\dd t$. Give both a symbolic answer (in terms of $m,A$, etc)
and a numerical answer.

\textsl{(c)}
The satellite orbital velocity $v$ depends on semi-major axis $a$.
Does this drag force, therefore, cause the satellite to speed up or slow down?
Find an expression for $\dd v/\dd t$ and also get a numerical value.
...
THIS IS AMBIGUOUS ABOUT WHICH DIRECTION YOU LAUNCH!
