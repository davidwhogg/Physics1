...
each block, and the total momentum and kinetic energy in the
center-of-mass frame, after the collision. Do your answers equal those
...
each block, and the total momentum and kinetic energy in the lab
frame, after the collision. Do your answers equal those in part
...
\textsl{(a)}~If the hanging block falls by a distance $h$, how what is
...
kinetic energy of the system should somehow be related both he
...
\paragraph{\problemname~\theproblem:}\refstepcounter{problem}%
In the static problem below, the pivot at the wall is frictionless,
and the strings are (effectively) massless. What are the tensions
$T_1$ and $T_2$ in the two strings, and the force $\vec{F}$ (give $x$
and $y$ components) on the beam at the pivot?
