...
\textsl{(e)} How fast (that is, at what ``muzzle velocity'') must you launch
...
\textsl{(b)}
What is the condition on the coefficient of friction $\mu$ to make it
possible for the object to roll without slipping?
...
\paragraph{Extra problem (will not be graded for credit):}%
Can you think of a way to design an object with mass $M$ and some kind of radius $R$
such that when you do rolling problems you get $I > M\,R^2$?
